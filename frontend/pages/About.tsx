      ...
      <section className="py-16 md:py-24 container mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2">
            <h2 className="text-2xl md:text-3xl font-bold text-green-950 mb-6 md:mb-8 tracking-tight leading-tight">
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-10 md:mb-14">
            ...
            <h3 className="text-2xl md:text-4xl font-bold text-green-950 tracking-tight leading-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {aboutLabels.cards.map((item) => (
              <div key={item.title} className="bg-white border border-gray-100 rounded-[2rem] p-8 shadow-sm hover:shadow-xl transition-all">
                ...
                <h4 className="text-lg font-bold tracking-tight text-green-950 mb-3">{item.title}</h4>
